...
printf '"backlog":"%s",' "$(st_cfg backlog 0)"
printf '"congestion":"%s",' "$(st_cfg congestion 1)"
printf '"flow_offload":"%s",' "$(st_cfg flow_offload 0)"
...
printf '"disable_ipv6":"%s",' "$(st_cfg disable_ipv6 1)"
printf '"mobile_lte":"%s",' "$(st_cfg mobile_lte 1)"
